  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="inline-flex items-center gap-2 bg-blue-600/10 border border-blue-500/30 text-emerald-400 text-xs px-4 py-1.5 rounded-full mb-6 font-medium backdrop-blur-sm">
          <FiShield />
        ...
        <h1 className="text-5xl font-bold text-white mb-4 leading-tight drop-shadow-lg">
          ...
          <span className="text-emerald-400">Banco Unión</span>
        </h1>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-xl font-semibold text-base transition-all shadow-xl shadow-blue-600/40 cursor-pointer"
        >
